...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="div" action="frontStorageActivatecodeController.do?doUpdate" >
		...
		<fieldset class="step">
			<div class="form">
		      <label class="Validform_label">激活码:</label>
		     	 <input id="activieCode" name="activieCode" type="text" style="width: 150px" class="inputxt"  datatype="*"  ignore="checked"  value='${frontStorageActivatecodePage.activieCode}' readonly/>
		      <span class="Validform_checktip"></span>
		    </div>
			<div class="form">
		      <label class="Validform_label">生成时间:</label>
					  <input id="generateTime" name="generateTime" type="text" style="width: 150px"  class="Wdate" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})"  datatype="*"  ignore="checked"  value='${frontStorageActivatecodePage.generateTime}' readonly/>
		      <span class="Validform_checktip"></span>
		    </div>
			<div class="form" style="display: none">
		      <label class="Validform_label">使用时间:</label>
					  <input id="useTime" name="useTime" type="text" style="width: 150px"  class="Wdate" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})"  ignore="ignore"  value='<fmt:formatDate value='${frontStorageActivatecodePage.useTime}' type="date" pattern="yyyy-MM-dd hh:mm:ss"/>'/>
		      <span class="Validform_checktip"></span>
		    </div>
			<div class="form" style="display: none">
