...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="div" action="usdtBankController.do?doUpdate" >
		...
		<fieldset class="step">
			<div class="form">
		      <label class="Validform_label">收款人开户行:</label>
		     	 <input id="bankname" name="bankname" type="text" style="width: 150px" class="inputxt"  datatype="*"  ignore="checked"  value='${usdtBankPage.bankname}'/>
		      <span class="Validform_checktip"></span>
		    </div>
			<div class="form">
		      <label class="Validform_label">收款人账号:</label>
		     	 <input id="accountno" name="accountno" type="text" style="width: 150px" class="inputxt"  datatype="n"  ignore="checked"  value='${usdtBankPage.accountno}'/>
		      <span class="Validform_checktip"></span>
		    </div>
			<div class="form">
