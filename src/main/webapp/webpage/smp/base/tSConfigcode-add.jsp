...
<body>
<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="div" action="tSConfigcodeController.do?doAdd" >
    ...
    <fieldset class="step">
        <div class="form">
            ...
            <input id="configName" name="configName" type="text" style="width: 150px" class="inputxt"  datatype="*"  ignore="checked" />
            <span class="Validform_checktip"></span>
        </div>
        <div class="form">
            <label class="Validform_label">参数配置代码:</label>
            <input id="configCode" name="configCode" type="text" style="width: 150px" class="inputxt"  datatype="*"  ignore="checked" />
            <span class="Validform_checktip"></span>
        </div>
        <div class="form">
            <label class="Validform_label">参数配置值:</label>
            <input id="configValue" name="configValue" type="text" style="width: 150px" class="inputxt"  datatype="*"  ignore="checked" />
            <span class="Validform_checktip"></span>
        </div>
        <div class="form">
