...
public class OrderInjectInfoServiceImpl extends CommonServiceImpl implements OrderInjectInfoServiceI {
    ...
    public void deleteByUserName(String userName) throws Exception{
 	    String query = "delete from order_inject_info where username='"+userName+"'";
        this.executeSql(query);
    }

    public void updateByUserName(String userName) throws Exception{
        String query = "update order_inject_info set username='RS" + userName + "'where username='"+userName+"'";
        this.executeSql(query);
    }
